...
<head>
    ...
    <title>UR Card Genearator | University of Rwanda</title>
    ...
    <div class="p-5 lg:p-10 h-screen lg:flex relative">
        <div class="w-full lg:w-1/2 m-auto lg:p-10 lg:flex">
            <div class="w-full lg:w-1/2">
                {{-- <img class="mb-4" src="{{asset('images/ur.png')}}" alt="" width="180"> --}}
                <img class="relative" width="350" src="{{asset('images/login.png')}}" alt="">
            </div>
